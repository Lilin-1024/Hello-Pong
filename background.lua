...
function Background.draw()
    love.graphics.clear(Background.BG_COLOR)
    ...
    for _, ball in ipairs(balls) do
        ...
        -- 设置颜色
        love.graphics.setColor(Background.BALL_COLOR[1], Background.BALL_COLOR[2], Background.BALL_COLOR[3], alpha)
